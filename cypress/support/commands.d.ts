// definição dos tipos dos comandos customizados
// sempre que criar um comando customizado é bom já criar um documento que o explique
...
declare namespace Cypress {
    interface Chainable {
         ...
         */
        login(username?: string, password?: string, options?: object): void | Cypress.Chainable<null> // ? indica que os parâmetros são opcionais
